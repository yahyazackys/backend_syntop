...
Route::get('/api/post-keranjang', [App\Http\Controllers\Api\ApiKeranjangController::class, 'postKeranjang']);

Auth::routes();
Route::get('/api/register', [App\Http\Controllers\Api\ApiUserController::class, 'register']);
